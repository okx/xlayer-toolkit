...
2. **Parse** ERC-8021 attribution from a transaction hash
3. **Deploy** the `BuilderCodes` registry contract, register a code, and send + parse a Schema 1 attribution transaction
...
## 3. Full End-to-End: Deploy Registry, Register a Code, Send + Parse a Schema 1 Tx
