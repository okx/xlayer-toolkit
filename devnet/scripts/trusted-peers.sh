...
if [ "$CONDUCTOR_ENABLED" = "true" ]; then
    ...
    # seq4
    TRUSTED_PEERS="${TRUSTED_PEERS},enode:////0f3ad88455de68563176835c2b5a79a759f2b560d9ca2dee5fd5e14ce3172596ee5d336ce6fe737b8c8d996b713fd21478a4f834b1ee3027e50f251d4ea6d0f8@op-${SEQ_TYPE}-seq4:30303"
fi
