...
template WCT8Hash7Pad() {
    signal input a0; signal input a1; signal input a2; signal input a3;
    signal input a4; signal input a5; signal input a6;
    signal output out;
    component perm = Poseidon2(8);
    perm.in[0] <== a0; perm.in[1] <== a1; perm.in[2] <== a2;
    perm.in[3] <== a3; perm.in[4] <== a4; perm.in[5] <== a5;
    perm.in[6] <== a6; perm.in[7] <== 0;
    out <== perm.out[0];
}
component main = WCT8Hash7Pad();
