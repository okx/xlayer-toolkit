...
main() {
    ...
    echo -e "${C_GREEN}  +${sline}+${C_RESET}"
    echo ""
    echo -e "${C_CYAN}    Network   ${C_RESET} $NETWORK_TYPE"
    echo -e "${C_CYAN}    Client    ${C_RESET} $RPC_TYPE"
    echo -e "${C_CYAN}    Mode      ${C_RESET} $SYNC_MODE"
    echo -e "${C_CYAN}    RPC       ${C_RESET} http://localhost:${RPC_PORT:-8545}"
    echo -e "${C_CYAN}    WebSocket ${C_RESET} ws://localhost:${WS_PORT:-8546}"
    echo -e "${C_CYAN}    Directory ${C_RESET} $WORK_DIR"
    echo ""
    echo -e "${C_DIM}  ──────────────────────────────────────────────────${C_RESET}"
    echo ""
